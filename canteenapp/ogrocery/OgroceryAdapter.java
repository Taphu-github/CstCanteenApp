package com.example.canteenapp.ogrocery;
...
public class OgroceryAdapter extends FirebaseRecyclerAdapter<OgroceryModel, OgroceryAdapter.MyViewHolder> {
     ...
     * @param options
     */
    public OgroceryAdapter(@NonNull FirebaseRecyclerOptions<OgroceryModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull MyViewHolder holder, int position, @NonNull OgroceryModel model) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new OgroceryAdapter.MyViewHolder(view);
    }
