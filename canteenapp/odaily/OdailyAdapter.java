...
public class OdailyAdapter extends FirebaseRecyclerAdapter<OdailyModel,OdailyAdapter.MyViewHolder> {
     ...
     * @param options
     */
    public OdailyAdapter(@NonNull FirebaseRecyclerOptions<OdailyModel> options) {
        super(options);
    }
