package com.example.canteenapp.grocery;
...
public class GroceryAdapter extends FirebaseRecyclerAdapter<OgroceryModel, GroceryAdapter.MyViewHolder> {
     ...
     * @param options
     */
    public GroceryAdapter(@NonNull FirebaseRecyclerOptions<OgroceryModel> options, SQLiteDatabase mdata) {
        super(options);
        this.mdata=mdata;
    }
    ...
    @Override
    protected void onBindViewHolder(@NonNull GroceryAdapter.MyViewHolder holder, int position, @NonNull OgroceryModel model) {
    ...
    public GroceryAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new GroceryAdapter.MyViewHolder(view);
    }
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    mdata.execSQL(insertSQL, new String[]{title.getText().toString(), price.getText().toString(),
                            imga.getText().toString()});
